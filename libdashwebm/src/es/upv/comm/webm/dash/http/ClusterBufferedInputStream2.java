 ...
 */
public class ClusterBufferedInputStream2 extends FilterInputStream implements Debug{
    /**
     ...
     */
    public ClusterBufferedInputStream2(InputStream in) {
        this(in, 8192);
    }
     ...
     */
    public ClusterBufferedInputStream2(InputStream in, int size) {
        super(in);
        if (size <= 0) {
    ...
    public synchronized long skip(long byteCount) throws IOException {
        // Use local refs since buf and in may be invalidated by an
        // unsynchronized close()
    	Log.d(LOG_TAG, HttpUtils.class.getSimpleName() + ": " + "Skip................................."+byteCount);
        byte[] localBuf = buf;
        InputStream localIn = in;
        if (localBuf == null) {
            throw streamClosed();
