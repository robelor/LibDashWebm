 ...
 */
public class ClusterBufferedInputStream extends FilterInputStream implements Debug{
    /**
     ...
     */
    public ClusterBufferedInputStream(InputStream in) {
        this(in, 8192);
    }
     ...
     */
    public ClusterBufferedInputStream(InputStream in, int size) {
        super(in);
        if (size <= 0) {
