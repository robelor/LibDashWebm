	...
	public static TrackEntry create(Element trackEntryElement, EBMLReader ebmlReader, DataSource dataSource) {
		...
		while (auxElement != null) {
			...
			if (auxElement.equals(MatroskaDocType.TrackNumber_Id)) {
				...
				if (D)
					Log.d(LOG_TAG, WebmContainer.class.getSimpleName() + ": " + "      TrackNumber: " + trackNumber);
				...
				if (D)
					Log.d(LOG_TAG, WebmContainer.class.getSimpleName() + ": " + "      TrackUid: " + trackUid);
				...
				if(flagLacing.length == 1){
					...
					if (D)
						Log.d(LOG_TAG, WebmContainer.class.getSimpleName() + ": " + "      FlagLacing: " + flag);
				...
				if(flagDefault.length == 1){
					...
					if (D)
						Log.d(LOG_TAG, WebmContainer.class.getSimpleName() + ": " + "      FlagDefault: " + flag);
				...
				if (D)
					Log.d(LOG_TAG, WebmContainer.class.getSimpleName() + ": " + "      CodedId: " + codecId);
				...
				if (D)
					Log.d(LOG_TAG, WebmContainer.class.getSimpleName() + ": " + "      TrackType: " + trackType); 
				...
				if (D)
					Log.d(LOG_TAG, WebmContainer.class.getSimpleName() + ": " + "      TrackDefaultDuration: " + defaulDuration);
				...
				if (D)
					Log.d(LOG_TAG, WebmContainer.class.getSimpleName() + ": " + "      TrackName: " + trackName);
				...
				if (D)
					Log.d(LOG_TAG, WebmContainer.class.getSimpleName() + ": " + "      TrackLanguage: " + trackLanguage);
				trackEntry.setmTrackName(trackLanguage);
				
			} else if (auxElement.equals(MatroskaDocType.TrackVideo_Id)) {
				if (D)
					Log.d(LOG_TAG, WebmContainer.class.getSimpleName() + ": " + "      Parsing Video...");
