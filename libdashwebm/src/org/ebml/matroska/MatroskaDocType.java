  ...
  static public byte [] Segment_Id = {0x18, 0x53, (byte)0x80, 0x67};
    ...
    static public byte [] Tracks_Id = {0x16, (byte)0x54, (byte)0xAE, (byte)0x6B};
      static public byte [] TrackEntry_Id = {(byte)0xAE};
        ...
        static public byte [] TrackFlagLacing = { (byte)0x9C};
        static public byte [] TrackFlagDefault = { (byte)0x88};
    ...
    static public byte [] CueingData_Id = {0x1C, (byte)0x53, (byte)0xBB, (byte)0x6B};
      static public byte [] CuePoint_Id = {(byte)0xBB};
        ...
        static public byte [] CueTrackPositions_Id = {(byte)0xB7};
          static public byte [] CueTrack_Id = {(byte)0xF7};
          static public byte [] CueClusterPosition_Id = {(byte)0xF1};
          static public byte [] CueBlockNumber_Id = {0x53, 0x78};
